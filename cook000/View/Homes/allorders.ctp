...
<body>
            ...
            <div class="row marginB15">       
               <div class="col-md-9 col-sm-8 col-xs-12 home-link">
                <div class="clearfix marginB15">
                  ...
                  <a href="javascript:void(0)" class="submitbtn" >Reprint 重印</a>
                </div>
                                    ...
                                    <div class="product-indent clearfix">
                                        <div class="product-top text-center">
                                            <?php
                                                ...
                                                echo "<span>".$category_name[0]."<br>".$category_name[1]."</span>";
                                            ?>, Table 表 #<?php echo $value['Order']['table_no'] ?>
                                        </div>
                                        <ul>
                                            <?php
                                                ...
                                                foreach ($category_items as $k => $i) {
                                                    ...
                                                    <li class="clearfix">
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <?php echo $i['name_en']."<br/>".$i['name_xh']; ?>
                                                        </div>
                                                        <?php 
    ...
    <?php
    echo $this->Html->script(array('jquery.min.js', 'bootstrap.min.js', 'slick.js'));
