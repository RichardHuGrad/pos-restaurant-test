...
$directory = $_SERVER['DOCUMENT_ROOT'] . '/pos/';
$url_directory = 'http://' . $_SERVER['HTTP_HOST'] . '/pos/';
...
define('WEBSITE_URL', $url_directory."restorant/");
...
define('TIMB_PATH', $url_directory.'manager/webroot/img/');
define('COUSINE_UPLOAD_PATH', $directory.'app/webroot/uploads/cousine_images/');
define('COUSINE_IMAGE_PATH', $url_directory.'manager/webroot/uploads/cousine_images/thumbnail/');

define('CASHIER_UPLOAD_PATH', $directory.'manager/webroot/uploads/cashier/');
define('CASHIER_IMAGE_PATH', $url_directory.'manager/webroot/uploads/cashier/thumbnail/');
