        ...
        newLang: function(){
			...
			"func": function (field) {
			 ...
			 "alertText": "* Invalid date, must be in YYYY-MM-DD format"
				...
				"validateMIMES":  {
					"regex": function(field,  i, options){
				   //add to input tag: data-validation-engine="validate[required, custom[validateMIME[image/jpeg|image/png]]]"

					var fileInput = field[0].files[0];
					var MimeFilter = new RegExp([3],'i');

					if (fileInput) {
						return MimeFilter.test(fileInput.type);
					} else { return true;}
				  },
				  "alertText": "* Wrong file Type. Only jpg, png jpeg are allowed",
				  //"alertText2": " Only doc, docx pdf are allowed", 
