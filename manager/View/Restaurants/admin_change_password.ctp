<script type="text/javascript">
    jQuery(document).ready(function () {
        jQuery("#cancel_button").click(function () {
            window.location.href = '<?php echo $this->Html->url(array('plugin' => false,'controller' => 'restaurants','action' => 'index', 'admin' => true)); ?>';
        });
    });
</script>
        ...
        <div class="main-content" >
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="mainTitle">Change Restaurant Password: <?php echo ucfirst($user_data['Restaurant']['firstname']) . ' ' . ucfirst($user_data['Restaurant']['lastname']); ?></h1>
                        </div>                        
                    </div>
                </section>
                <!-- end: PAGE TITLE -->
                ...
                <div class="container-fluid container-fullw bg-white">
                    <div class="row">
                        <div class="col-md-12">   
                            <?php echo $this->Form->create('Restaurant', array('class' => 'form', 'role' => 'form', 'autocomplete' => 'off')); ?>
                            <div class="row">
