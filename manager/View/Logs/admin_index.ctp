...
<?php 
$search_txt = $logs = $name = $operation = $created = '';
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-12 col-md-12">
                            <h1 class="mainTitle pull-left">Log</h1>
                        </div>                        
                    </div>
                </section>
                ...
                <div class="container-fluid container-fullw bg-white">
                    ...
                    <div class="border-around margin-bottom-15 padding-10">
                        <?php echo $this->Form->create('Log', array(
                            'url' => array('controller' => 'Logs', 'action' => 'index', 'admin' => true), 'class' => 'form', 'role' => 'search', 'autocomplete' => 'off')
                        ); ?>
                        ...
                        <div class="col-md-9" style="margin-top: 15px;">
                            <div class="form-group">
                                <div class="col-md-3">
                                    <?php echo $this->Form->input('name', array('type' => 'text', 'value' => $search_txt, 'placeholder' => 'Search name', 'class' =>'form-control reset-field', 'div' => false, 'label' => false, 'required' => false)); ?>
                                </div>
                                <div class="col-md-3" >
                                    <?php echo $this->Form->input('operation', array('value' => $operation, 'placeholder' => 'Operation', 'type' => 'text', 'class' =>'form-control reset-field', 'div' => false, 'label' => false, 'required' => false)); ?>
                                </div>
                                <div class="col-md-3" >
                                    <?php echo $this->Form->input('logs', array('value' => $logs, 'placeholder' => 'Logs', 'type' => 'text', 'class' =>'form-control reset-field', 'div' => false, 'label' => false, 'required' => false)); ?>
                                </div>
                                <div class="col-md-3" >
                                    <?php echo $this->Form->input('created', array('value' => $created, 'placeholder' => 'Created time', 'type' => 'text', 'class' =>'form-control datepicker reset-field', 'div' => false, 'label' => false, 'required' => false)); ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <?php echo $this->Form->create('PageSize', array(
                            'url' => array('controller' => 'Logs', 'action' => 'index', 'admin' => true), 'class' => 'form', 'autocomplete' => 'off', 'id' => 'pageSizeForm')
                    ); ?>
                    <?php 
                    if('Y' ==  $is_super_admin){
                    ?>
                        ...
                        <div class="col-md-12">                           
                            ...
                            <div class="col-md-6" style="margin-top: 22px;">
                                ...
                                <div class="pull-left advance_panel col-md-8">
                                    ...
                                    <!-- <div class="checkbox col-md-4" style="margin-left:0px; margin-top:0px">
                                        <label  id="delete_Log"> Delete</label>
                                    </div>    -->
                                    <button class="btn btn-info" id="delete_Log">Delete</button>                
                                </div>
                            <?php }?>
...
$(document).ready(function() {
    ...
    $('#delete_Log').on('click', function () {
        ...
        //console.log(ids);
        $.ajax({
            url:  "<?php echo $this->Html->url(array('controller' => 'Logs', 'action' => 'batch_delete', 'admin' => true)); ?>",
            method: "post",
            data: {"ids": ids},
