                            ...
                            <table class="table table-striped table-bordered table-hover table-full-width">
                                ...
                                <?php if (!empty($records)) { ?>
                                    <?php foreach ($records as $rc) { ?>
                                        <tr>
                                            <td><?php echo $rc['m']['id']; ?></td>
                                            <td><?php echo $rc['m']['cardnumber']; ?></td>
                                            <td><?php echo $rc['m']['name']; ?></td>
                                            <td><?php echo $rc['m']['phone']; ?></td>
                                            <td><?php echo $rc[0]['charged_cnt']; ?></td>
                                            <td><?php echo number_format($rc[0]['charged_amt'], 2); ?></td>
                                            <td><?php echo $rc[0]['paid_cnt']; ?></td>
                                            <td><?php echo number_format($rc[0]['paid_amt'], 2); ?></td>
                                        </tr>
                                        <?php
                                    }
                                } else {
