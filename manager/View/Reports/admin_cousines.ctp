            ...
            <div class="wrap-content container" id="container">
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-12 col-md-12">
                            <h1 class="mainTitle pull-left">Cousines Reports List</h1>
                        </div>                        
                    </div>
                </section>
                ...
                <div class="container-fluid container-fullw bg-white">
                    ...
                    <div class="border-around margin-bottom-15 padding-10">
                        <?php echo $this->Form->create('Order', array('url' => array('controller' => 'reports', 'action' => 'cousines', 'admin' => true), 'class' => 'form', 'role' => 'search', 'autocomplete' => 'off', 'type'=>'get')); ?>
                        <div class="col-md-4">
                    ...
                    <div class="panel panel-white no-radius" id="visits">
                        <div class="panel-heading border-light">
                            <h1 class="panel-title"> Cousines Sales </h1>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover table-full-width">
                                ...
                                <?php if (!empty($records)) { ?>
                                    <?php foreach ($records as $rc) { ?>
                                        <tr>
                                            <!-- td><?php echo $rc['OrderItem']['item_id']; ?></td -->
                                            <td><?php echo ucfirst($rc['OrderItem']['name_xh']); ?> ( <?php echo ucfirst($rc['OrderItem']['name_en']); ?> )</td>
