                        ...
                        <div class="col-sm-4">
                            <div class="panel panel-white no-radius text-center">
                                <div class="panel-body">
                                    ...
                                    <h2 class="StepTitle">Manage Locations</h2>
                                    <p class="text-small">
                                        To view detail of Locations.
                                    </p>
                                    <p class="links cl-effect-1">
                                       <a href="<?php echo $this->Html->url(array('plugin' => false,'controller' => 'locations','action' => 'index')); ?>">
									   Click Here
									   </a>
                        ...
                        <div class="col-sm-4">
                            <div class="panel panel-white no-radius text-center">
                                <div class="panel-body">
                                    ...
                                    <h2 class="StepTitle">Manage Drivers</h2>
                                    <p class="text-small">
